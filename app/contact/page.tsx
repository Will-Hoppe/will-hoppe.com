...
export default function Example() {
	return (
		<div className="bg-transparent border border-zinc-500 min-h-screen bg-gradient-to-tl from-black z-0 via-zinc-900 min-h-screen to-slate-900">
		<div className="">
			...
			<div className="container flex items-center justify-center px-4 mx-auto">
				...
				<div className="grid w-full grid-cols-2 gap-8 mt-32 sm:mt-32 sm:grid-cols-4 lg:gap-16">
					...
					{socials.map((s) => (
						<Card>
							<Link
								...
								href={s.href}
								target="_blank"
								className="p-4 relative flex flex-col items-center text-center gap-4 aspect-square duration-700 group md:gap-7 md:py-10  lg:pb-30  md:p-10"
							>
			...
			<br></br><p className="px-20 leading-6 tracking-tight font-medium font-mono mb-10 text-gray-400">I am planning on graduating in 2025, but am looking for an internship position for summer 2024. Please feel free to check out my projects and contact me!</p>
			</div>
		</div>
	);
}
