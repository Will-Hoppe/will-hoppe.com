...
export default function Example() {
	return (
		...
		<div className="">
					...
					{socials.map((s) => (
						<Card>
							<Link
								...
								href={s.href}
								target="_blank"
								className="p-4 relative flex flex-col items-center text-center gap-4 duration-700 group md:gap-7 md:py-10  lg:pb-30  md:p-10"
							>
			...
			<br></br><p className="px-20 mb-5 leading-6 tracking-tight font-medium font-mono text-gray-400">I am planning on graduating in 2025, but am looking for an internship position for summer 2024. Please feel free to check out my projects and contact me!</p>
		</div>
		</div>
	);
}
